...
int main() {
    // Test case 1: Simple 2-variable function
    cout << "\n\n=====================================" << endl;
    cout << "Test Case 1" << endl;
    cout << "=====================================" << endl;
    vector<int> minterms1 = {24, 37, 83, 138, 217, 228, 269, 354, 368, 376, 415, 476, 508};
    vector<int> dontcares1 = {54, 175, 214, 301, 316, 332, 336, 358, 398, 412, 428, 473};

    QmSolution* sol1 = solveQm(8, minterms1, dontcares1, true);
    
    cout << "\nPrime Implicants:" << endl;
    for (const auto& prime : sol1->primes) {
        cout << "  " << prime << endl;
    }
    
    cout << "\nMinimum SOPs:" << endl;
    for (size_t i = 0; i < sol1->minimumSops.size(); i++) {
        cout << "  Solution " << (i + 1) << ": ";
        for (size_t j = 0; j < sol1->minimumSops[i].size(); j++) {
            cout << sol1->minimumSops[i][j];
            if (j < sol1->minimumSops[i].size() - 1)
                cout << " + ";
        }
        cout << endl;
    }
